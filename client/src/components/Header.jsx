...
export function Header() {
  ...
  return (
    <header className="relative bg-primary text-(--color-primary-foreground) shadow-lg z-50">
      <PatternBackground />
      <div className="container mx-auto px-4 py-4 relative z-10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="icon"
            className="text-(--color-primary-foreground) hover:bg-white/10 hover:text-accent"
          >
          ...
          <Link to="/cart">
            <Button
              variant="ghost"
              size="icon"
              className="text-(--color-primary-foreground) hover:bg-white/10 hover:text-accent relative"
            >
              <ShoppingCart className="w-5 h-5" />
              {/* Badge */}
              <span className="absolute top-0 right-0 h-4 w-4 bg-accent text-(--color-accent-foreground) text-[10px] flex items-center justify-center rounded-full font-bold">
                0
              </span>
            </Button>
          </Link>
            ...
            <div className="flex items-center gap-2">
              <Link to="/account">
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-(--color-primary-foreground) hover:bg-white/10"
                >
          ...
          <Button
            variant="ghost"
            size="icon"
            className="md:hidden text-(--color-primary-foreground)"
          >
